    ...
    <nav class="bg-white border-b border-gray-200" x-data="{ mobileMenuOpen: false }">
          ...
          <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
            ...
            <div class="hidden sm:ml-6 sm:block">
              <div class="flex space-x-4">
                <a href="{{ route('dashboard') }}" class="rounded-md bg-indigo-50 text-indigo-700 px-3 py-2 text-sm font-medium" aria-current="page">Home</a>
                <a href="{{ route('coming-soon') }}" class="rounded-md px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-100 hover:text-indigo-700">Marketplace</a>
                <a href="{{ route('coming-soon') }}"class="rounded-md px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-100 hover:text-indigo-700">Promo</a>
                <a href="{{ route('statustransaksi') }}" class="rounded-md px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-100 hover:text-indigo-700">Riwayat</a>
              </div>
            </div>
          </div>
      ...
      {{-- <div class="sm:hidden" id="mobile-menu" x-show="mobileMenuOpen" x-transition>
        <div class="space-y-1 px-2 pt-2 pb-3 bg-white border-t border-gray-200">
          <a href="{{ route('dashboard') }}" class="block rounded-md bg-indigo-50 text-indigo-700 px-3 py-2 text-base font-medium" aria-current="page">Home</a>
          ...
          <a href="{{ route('statustransaksi') }}" class="block rounded-md px-3 py-2 text-base font-medium text-gray-700 hover:bg-gray-100 hover:text-indigo-700">Riwayat</a>
        </div>
      </div>
    </nav> --}}
...
<nav class="fixed bottom-0 left-0 right-0 z-30 bg-white sm:hidden rounded-t-[32px] shadow-lg"
    ...
    <footer class="bg-white border-t hidden sm:block">
        <div class="container mx-auto px-4 py-6 text-center text-gray-500">
            &copy; {{ date('Y') }} Rekberku. All rights reserved.
        </div>
    </footer>
</body>
</html>